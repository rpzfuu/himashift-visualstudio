...
namespace HIMASHIFT.UserControls
{
    public partial class anggota : UserControl
    {
        ...
        private void Dashboard_Load(object sender, EventArgs e)
        {
            ...
            connection.Open();
            string query = "SELECT mahasiswa.nama, divisi.nama_divisi FROM mahasiswa JOIN mahasiswa_divisi ON mahasiswa.nim = mahasiswa_divisi.nim JOIN divisi ON mahasiswa_divisi.id_divisi = divisi.id_divisi";
            ...
            tabel.Columns[1].HeaderText = "Nama";
            tabel.Columns[2].HeaderText = "Divisi";
